...
const Hero = ({ children }) => (
  <>
    <Divider speed={0.2} offset={0}>
      <UpDown>
        <SVG icon="triangle" width={32} stroke={"#34b295"} left="10%" top="5%" />
        <SVG icon="circle" width={64} fill={"#d6101c"} left="60%" top="30%" />
      ...
      <SVG icon="upDown" width={8} fill={colors.white} left="95%" top="90%" />
      <SVG icon="upDown" width={24} fill={"#a4aad7"} left="40%" top="80%" />
      <SVG icon="triangle" width={8} stroke={colors['grey-darker']} left="25%" top="5%" />
      <SVG icon="box" width={48} fill={"#d597bd"} left="5%" top="90%" />
      <SVG icon="box" width={6} fill={colors['grey-darkest']} left="10%" top="10%" />
      <SVG icon="box" width={12} fill={colors['grey-darkest']} left="40%" top="30%" />
      <SVG icon="triangle" width={16} stroke={colors['grey-darker']} left="10%" top="50%" />
      <SVG icon="circle" width={8} fill={colors['grey-darker']} left="80%" top="70%" />
    </Divider>
